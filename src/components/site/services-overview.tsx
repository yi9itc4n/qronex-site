  ...
  const services = [
    {
      ...
      description: t("onSiteRapidResponse.intro"),
      features: [t("onSiteRapidResponse.highlights.h1"), t("onSiteRapidResponse.highlights.h2"), t("onSiteRapidResponse.highlights.h3")],
      color: "text-red-600",
      bgColor: "bg-red-50",
    ...
    },
    {
      ...
      description: t("sortingContainment.intro"),
      features: [t("sortingContainment.highlights.h1"), t("sortingContainment.highlights.h2"), t("sortingContainment.highlights.h3")],
      color: "text-blue-600",
      bgColor: "bg-blue-50", 
    ...
    },
    {
      ...
      description: t("qualityEngineering.intro"),
      features: [t("qualityEngineering.highlights.h1"), t("qualityEngineering.highlights.h2"), t("qualityEngineering.highlights.h3")],
    ...
    },
    {
      ...
      features: [t("operationalExcellence.feature1"), t("operationalExcellence.feature2"), t("operationalExcellence.feature3")],
    ...
    },
    {
      ...
      features: [t("advancedProjectOperationalSupport.feature1"), t("advancedProjectOperationalSupport.feature2"), t("advancedProjectOperationalSupport.feature3")],
      color: "text-teal-600",
      bgColor: "bg-teal-50",
