...
export function ServicesOverview() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: t("technicalRepresentation.intro"),
      features: [t("technicalRepresentation.highlights.h1"), t("technicalRepresentation.highlights.h2"), t("technicalRepresentation.highlights.h3")],
      color: "text-teal-600",
      bgColor: "bg-teal-50",
