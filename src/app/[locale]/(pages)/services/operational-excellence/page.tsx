...
export default function OperationalExcellencePage() {
  ...
  const t = useTranslations("servicesDetails.operationalExcellence");
      ...
      <section className="section-padding bg-blue-green-gradient text-white">
        <div className="container mx-auto container-padding text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Let our expert consultants and trainers help you build world-class operational management capabilities
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
