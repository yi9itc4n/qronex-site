  ...
  const services = [
    {
      ...
      description: "Comprehensive quality control and inspection services at your customer locations",
      features: [
    ...
    {
      icon: Wrench,
      title: "Customer Location Rework",
      description: "Professional rework and repair services to restore product quality",
      features: [
    ...
    },
    {
      ...
      description: "Implementation and optimization of quality control systems",
      features: [
    ...
    },
    {
      ...
      description: "Rapid response to quality issues to minimize downtime",
      features: [
        ...
        <div className="container mx-auto container-padding">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Quality Inspection & Rework @ Customer
            </h1>
            <p className="text-xl lg:text-2xl text-slate-200 mb-8">
              Comprehensive quality inspection and rework services at customer locations
            </p>
        ...
        <div className="container mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional quality inspection and rework services delivered at your customer locations
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container mx-auto container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Systematic approach to quality inspection and rework at customer locations
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Why Choose Our Quality Services?
              </h2>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-green-100 text-green-800">24-48 Hours</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Service Location</span>
                  <Badge className="bg-blue-100 text-blue-800">Customer Site</Badge>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-orange-100 text-orange-800">ISO Certified</Badge>
                </div>
              </div>
            </div>
          </div>
